...
function AdminCompany() {
  const { adminCompany, fetchAdminCompany, Loading, total, error  } = useContext(DataContext);
  ...
  const filteredCompanies = Array.isArray(adminCompany)
    ? adminCompany.filter(c =>
        [
          c.id,
          c.companycode,
          c.companyname,
  ...
  const handleCompanySaved = () => {
    fetchAdminCompany( ); // refresh list after save
  };
      ...
      >
        ...
        (
          <CompanyForm
            ...
            fetchAdminCompany={() => fetchAdminCompany(accessToken)} 
            handleNew={handleNew} 
